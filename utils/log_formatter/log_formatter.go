...
func (f *Formatter) Format(entry *logrus.Entry) ([]byte, error) {
	...
	// commonReq := model.CommonRequest{}
	// if entry.Context != nil {
	// 	_, ok := entry.Context.Value("common_request").(model.CommonRequest)
	// 	if ok {
	// 		commonReq = entry.Context.Value("common_request").(model.CommonRequest)
	// 	}
	// }
